...
- `mas_customize_scaling` Optional, ConfigMap name used for customizing MAS Core resources scaling settings. MAS provides the following buit-in t-shape sizes: small/medium/large. 
