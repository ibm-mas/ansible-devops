...
This will load a predefined workload scale configuration that is going to be applied to Suite CR. Can be set to either Burstable, BestEffort or Guaranteed. The default value is Burstable.
