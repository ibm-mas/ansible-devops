...
class ELBv2Helper():
    '''
    Object used to access the AWS ELB v2 service
    '''

    def __init__(self, aws_config):
        self.__elb_v2_session = self.__create_client_session(aws_config)
    ...
    def __create_client_session(self, aws_config):
        ...
        try:
            ...
            elbv2_session = aws_session.client('elbv2')
            return elbv2_session
    ...
    def describe_resource(self, operation_name, object_key):
        ...
        paginator = self.__elb_v2_session.get_paginator(operation_name)
    ...
    def get_num_elb_v2(self):
        elb = self.describe_resource('describe_load_balancers', 'LoadBalancers')
        return len(elb)
