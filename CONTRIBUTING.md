...
ansible-galaxy collection build --force && ansible-galaxy collection install ibm-mas_devops-5.1.2.tar.gz -p /home/david/.ansible/collections --force
...
ansible-galaxy collection publish ibm-mas_devops-5.1.2.tar.gz --token=$ANSIBLE_GALAXY_TOKEN
```
