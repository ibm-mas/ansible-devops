...
ansible-galaxy collection build --force && ansible-galaxy collection install ibm-mas_devops-4.3.1.tar.gz -p /home/david/.ansible/collections --force
...
ansible-galaxy collection publish ibm-mas_devops-4.3.1.tar.gz --token=$ANSIBLE_GALAXY_TOKEN
```
