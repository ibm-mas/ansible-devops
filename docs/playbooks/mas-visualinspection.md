...
## Prerequisites
You will need a RedHat OpenShift v4.8 cluster with IBM Maximo Application Suite Core v8.9. The [mas_install_core] (mas-core.md) playbook can be used to set this up.
