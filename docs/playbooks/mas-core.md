...
2. [Install Certificate Manager Operator](../roles/cert_manager.md) (3 minutes)
3. [Install Mongodb Operator and Create a Cluster](../roles/mongodb.md) (10 minutes, skipped if SKIP_MONGO set to TRUE))
4. [Install and bootstrap IBM Suite License Service](../roles/sls.md) (10 minutes)
5. [Install IBM User Data Services](../roles/uds.md) (30 minutes)
6. [Generate a MAS Workspace Configuration](../roles/gencfg_workspace.md) (1 minute)
7. [Configure Cloud Internet Services Integration for Maximo Application Suite](../roles/suite_dns.md) (Optional, 1 minute)
8. [Install Maximo Application Suite Core Services](../roles/suite_install.md) (1 minute)
9. [Configure Maximo Application Suite](../roles/suite_config.md) (1 minute)
10. [Verify the Install and Configuration of Maximo Application Suite](../roles/suite_verify.md) (25 minutes)
