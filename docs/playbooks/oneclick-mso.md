# Install Maximo Scheduler Optimization (MSO) Application
...
## Overview
This playbook will add **Maximo MSO v8.1** to an existing IBM Maximo Application Suite Core installation.  MSO will be configured to accept automatic security updates and bug fixes, but not new feature releases.
...
- Install Maximo Scheduler Optimization application:
...
ansible-playbook ibm.mas_devops.oneclick_add_mso
```
