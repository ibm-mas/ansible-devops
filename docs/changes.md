...
- `12.7` Added JDBC configuration to connect to an external SSL and not SSL enabled database for Manage application (DB2, Oracle and SQL Server) ([#600]( https://github.com/ibm-mas/ansible-devops/pull/600))
